...
export default function ForexPage(): React.JSX.Element {
    ...
    const [apiRates, setApiRates] = useState<{ [key: string]: number } | null>(null);
    const [lastUpdate, setLastUpdate] = useState<string>("");

    // 현재 시각 포맷팅 함수 (YYYY.MM.DD HH:mm)
    ...
    useEffect(() => {
        ...
        // 1분(60,000ms) 간격으로 시간을 자동 인터벌 갱신
    ...
    return (
        <div
            ...
            <div
                ...
                <span>홈</span>
                <span>여행</span>
                <span style={{ color: "#222222", fontWeight: "bold" }}>환율</span>
                <span>마이</span>
            </div>
            ...
            <div
                ...
                {ratesData.map((item, idx) => (
                    <div
                        key={item.symbol}
                        style={{ marginBottom: idx !== ratesData.length - 1 ? "18px" : "0" }}>
                        <div
                            style={{
                                display: "flex",
                            ...
                            <span style={{ fontWeight: "700", fontSize: "13px", color: "#222" }}>
                                {item.symbol}
                            </span>
                            <span
                                style={{ fontSize: "12px", fontWeight: "700", color: item.color }}>
            ...
            <div
                ...
                {[
                    { id: "홈", label: "홈", path: "M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" },
                    {
                        id: "여행",
                        label: "여행",
